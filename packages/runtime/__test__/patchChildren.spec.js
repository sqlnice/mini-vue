...
describe('element anchor order check', () => {
  ...
  test('tag and text order', () => {
    render(
      h('div', null, [
        h(Shape.Text, null, 'text1'),
        h('p'),
        h(Shape.Text, null, 'text2')
      ]),
      root
    )
  ...
  test('tag and text will be more or less', () => {
    render(h('div', null, [h(Shape.Text, null, 'text1')]), root)
...
describe('fragment anchor order', () => {
  test('fragment to element', () => {
    render(h(Shape.Fragment, null, [h('div')]), root)
  ...
  test('fragment order', () => {
    let result
    result = makeNodes(['h1', 'h2', 'h3', 'h4', 'h5', 'h6'])
    render(h(Shape.Fragment, null, result.nodes), root)
  ...
  //       h(Shape.Fragment, null, result1.nodes),
  //       h(Shape.Fragment, null, result2.nodes),
  //       h(Shape.Fragment, null, result3.nodes)
  //     ]),
  //     root
  //   )
  ...
  //   result1 = makeNodes(['h1', 'h2', 'h3'])
  //   render(
  //     h(Shape.Fragment, null, [h(Shape.Fragment, null, result1.nodes)]),
  //     root
  //   )
...
describe('patchChildren', () => {
  test('text children -> text children -> null', () => {
    render(h(Shape.Text, null, 'foo'), root)
    expect(root.innerHTML).toBe('foo')

    render(h(Shape.Text, null, 'bar'), root)
  ...
  test('text children => array children 1', () => {
    render(h(Shape.Text, null, 'text'), root)
    expect(root.innerHTML).toBe('text')

    render(h(Shape.Fragment, null, [h('div'), h('div')]), root)
