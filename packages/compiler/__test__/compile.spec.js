...
describe('compiler: integration tests', () => {
  describe('text and interpolation', () => {
    ...
    test('expression', () => {
      ...
      expect(code).toBe('h(Shape.Text, null, foo + bar)')
    })

    test('consecutive text', () => {
      const code = compile('{{ foo }} bar {{ baz }}')
      expect(code).toBe(
        '[h(Shape.Text, null, foo), h(Shape.Text, null, " bar "), h(Shape.Text, null, baz)]'
      )
    })
    ...
    test('consecutive text between elements', () => {
      ...
      expect(code).toBe(
        '[h("div"), h(Shape.Text, null, foo), h(Shape.Text, null, " bar "), h(Shape.Text, null, baz), h("div")]'
      )
    })

    test('text between elements (static)', () => {
      const code = compile('<div/>hello<div/>')
      expect(code).toBe('[h("div"), h(Shape.Text, null, "hello"), h("div")]')
    })

    test('consecutive text mixed with elements', () => {
      const code = compile('<div/>{{ foo }} bar {{ baz }}<div/>hello<div/>')
      expect(code).toBe(
        '[h("div"), h(Shape.Text, null, foo), h(Shape.Text, null, " bar "), ' +
          'h(Shape.Text, null, baz), h("div"), h(Shape.Text, null, "hello"), h("div")]'
      )
    })
  })
  ...
  describe('element', () => {
    ...
    test('import + resolve component', () => {
      const code = compile('<Foo/>')
      expect(code).toBe('h(resolveComponent("Foo"))')
    })
  ...
  describe('v-if', () => {
    test('basic v-if', () => {
      ...
      expect(code).toBe('ok ? h("div") : h(Shape.Text, null, "")')
    })
    ...
    test('v-if + v-else-if', () => {
      ...
      expect(code).toBe(
        'ok ? h("div") : orNot ? h("p") : h(Shape.Text, null, "")'
      )
    })
  ...
  describe('v-for', () => {
    test('number expression', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(5, index => h("span")))'
      )
    })
    ...
    test('object de-structured value', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(items, ({ id, value }) => h("span")))'
      )
    })
    ...
    test('value and key', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(items, (item, key) => h("span")))'
      )
    })
    ...
    test('value, key and index', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(items, (value, key, index) => h("span")))'
      )
    })
    ...
    test('with key', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(items, item => h("span", { key: item.id })))'
      )
    })
    ...
    test('skipped key', () => {
      ...
      expect(code).toBe(
        'h(Shape.Fragment, null, renderList(items, (value,,index) => h("span")))'
      )
    })
    ...
    test('v-if + v-for', () => {
      ...
      expect(code).toBe(
        'ok ? h(Shape.Fragment, null, renderList(list, i => h("div"))) : h(Shape.Text, null, "")'
      )
    })
  })
  ...
  describe('v-bind, v-on', () => {
    ...
    test('compound', () => {
      const code = compile(`
            ...
            `)
      expect(code).toBe(
        'ok ? h(Shape.Fragment, null, renderList(items, item => h("div", { style: "color: red", class: class, onClick: foo }))) : h(Shape.Text, null, "")'
      )
    })
  })
})
